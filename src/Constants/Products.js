const products = [
{
    ...
    description:["G400 is an easy to operate glass washer with a 400 x 400mm basket that holds 16 pint-sized glasses.",
...
},
{
    ...
    description:["The D500 is an easy to operate dishwasher with a 500 x 500mm basket that holds 18 full-sized plates.", 
...
},
{
    ...
    description:["Hood operated start/stop functions.", 
...
},
{
    ...
    description:["Radial wash tanks sloped to help emptying the tanks.",
...
},
{
    ...
    description:["AISI 304 structure",
...
},
{
    ...
    description:["Steam generated by injecting water into the cooking chamber",
...
},
{
    ...
    description:["MODEL:WBM 1080T PDRT",
...
},
{
    ...
    description:["Easy touch 10''TFT hirs", 
