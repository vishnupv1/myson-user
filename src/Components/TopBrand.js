...
const TopBrands = () => {
  const images = [
    ...
    "https://westernequipments.com/wp-content/uploads/2023/10/western-head-logo.png",
    "https://info.welbilt.com/hs-fs/hubfs/RGB_CRE_Grey-1.png?width=254&height=77&name=RGB_CRE_Grey-1.png",
